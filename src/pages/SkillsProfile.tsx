...
import { Users, Briefcase, Balance, Clock, ChevronDown, ChevronLeft, ChevronRight, HelpCircle } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
        ...
        <div className="max-w-7xl mx-auto space-y-6 bg-white rounded-lg p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <StatCard
              ...
              value="50%"
              icon={<Balance className="h-6 w-6 text-primary-icon" />}
            />
            <StatCard
