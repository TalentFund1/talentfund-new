...
const MarketData = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <Sidebar />
      <div className="flex-1 p-4 ml-16 transition-all duration-300">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div className="space-y-1">
                <label className="text-sm text-[#1F2144]">Graduation Year</label>
              ...
              <div className="space-y-1">
                <label className="text-sm text-[#1F2144]">Graduation Program</label>
                <Select defaultValue="">
              ...
              <div className="space-y-1">
                <label className="text-sm text-[#1F2144]">Timeframe</label>
                <div className="flex items-center gap-2">
