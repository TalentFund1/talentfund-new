              ...
              <Tabs defaultValue="location" className="w-full">
                ...
                <TabsContent value="location" className="space-y-6 mt-6">
                  <div className="space-y-6">              
                    ...
                    Certainly! I'll add two tabs to the Market Data page using the existing website functionalities. We'll use the `Tabs` component from the shadcn/ui library to implement this feature. Let's update the `MarketData.tsx` file to include these tabs.

<lov-code>
To implement the tabs for the Market Data page, we need to:
1. Import the necessary components from shadcn/ui
2. Modify the `MarketData.tsx` file to include the tabs

Let's update the `MarketData.tsx` file:

<lov-write file_path="src/pages/MarketData.tsx">
import React, { useState } from 'react';
import { Button } from "@/components/ui/button";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Sidebar } from '@/components/Sidebar';
              ...
              <Tabs defaultValue="location" className="w-full">
                ...
                <TabsContent value="compensation">
                  <div className="space-y-6">
                    ...
                    {/* Add compensation analysis components here when they are available */}
                  </div>
                </TabsContent>
              </Tabs>
            </div>
