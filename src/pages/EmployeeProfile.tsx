...
const EmployeeProfile = () => {
  ...
  const employee = employees[0]; // For demo purposes, using first employee
      ...
      <div className="flex-1 p-6 ml-16 transition-all duration-300">
        <div className="max-w-7xl mx-auto space-y-6">
          <Card className="p-6 bg-white">
            <EmployeeHeader id={employee.id} employee={employeeData} />
          </Card>
          ...
          <Tabs defaultValue={activeTab} className="w-full space-y-6">
            ...
            <TabsContent value="profile">
              <EmployeeDetails employee={employeeData} id={employee.id} />
            </TabsContent>
