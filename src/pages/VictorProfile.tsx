                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        <h1 className="text-2xl font-bold text-foreground">Victor Smith</h1>
                        <span className="text-sm text-muted-foreground bg-background px-2 py-1 rounded">ID: 124</span>
                      </div>
                      <h2 className="text-lg font-medium text-foreground/90">AI Engineer: P4</h2>
                    </div>
