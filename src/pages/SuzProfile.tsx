          ...
          <SelectedSkillsProvider>
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex items-center gap-2 bg-white rounded-lg border border-border px-3 py-1.5">
                ...
                <span className="text-sm text-foreground">3/7</span>
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        <h1 className="text-2xl font-bold text-foreground">Suz Manu</h1>
                        <span className="text-sm text-muted-foreground bg-background px-2 py-1 rounded">ID: 126</span>
                      </div>
                      <h2 className="text-lg font-medium text-foreground/90">Engineering Manager: M3</h2>
                    </div>
