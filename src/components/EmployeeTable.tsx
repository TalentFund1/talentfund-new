        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border">
              <th className="h-12 px-4 text-sm font-medium text-muted-foreground w-[6%]">
              ...
              <th className="h-12 px-4 text-sm font-medium text-muted-foreground text-left w-[18%]">Department</th>
