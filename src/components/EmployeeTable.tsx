        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border">
              <th className="h-12 px-4 text-xs font-medium text-muted-foreground w-[5%]">
                <input type="checkbox" className="rounded border-gray-300" />
              </th>
              <th className="h-12 px-4 text-xs font-medium text-muted-foreground text-left w-[22%]">
                <div className="flex items-center gap-1">
                  Employee Name <ChevronDown className="h-3 w-3" />
                </div>
              </th>
              <th className="h-12 px-4 text-xs font-medium text-muted-foreground text-left w-[18%]">Current Role</th>
              <th className="h-12 px-4 text-xs font-medium text-muted-foreground text-left w-[14%]">Department</th>
              <th className="h-12 px-4 text-xs font-medium text-muted-foreground text-center w-[14%]">Skill Count</th>
              <th className="h-12 px-4 text-xs font-medium text-muted-foreground text-center w-[14%]">Benchmark</th>
              <th className="h-12 px-4 text-xs font-medium text-muted-foreground text-right w-[13%]">Last Updated</th>
            </tr>
          </thead>
          <tbody>
