        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="h-16 px-3 text-sm font-medium text-muted-foreground text-left w-[18%]">Current Role</th>
              <th className="h-16 px-3 text-sm font-medium text-muted-foreground text-left w-[14%]">Department</th>
              <th className="h-16 px-3 text-sm font-medium text-muted-foreground text-center w-[14%]">Skill Count</th>
              <th className="h-16 px-3 text-sm font-medium text-muted-foreground text-center w-[14%]">Benchmark</th>
              <th className="h-16 px-3 text-sm font-medium text-muted-foreground text-right w-[13%]">Last Updated</th>
            </tr>
          </thead>
          <tbody>
