  ...
  return (
    <TableHeader>
      <TableRow className="bg-[#F7F9FF] border-b border-[#CCDBFF]">
        ...
        {isRoleBenchmark && (
          <TableHead className="w-[180px] text-center border-r border-[#CCDBFF] py-3 font-medium">Role Skills</TableHead>
        )}
        <TableHead className="w-[180px] text-center border-r border-[#CCDBFF] py-3 font-medium">Skill Level</TableHead>
