  ...
  return (
    <TableCell className="border-r border-blue-200 p-0">
      <div className="flex flex-col items-center p-1">
        <div className={`
          rounded-t-xl px-3 py-2 text-sm font-medium w-full capitalize flex items-center justify-center min-h-[37px] text-[#1f2144]
        ...
        <div className={`
          ...
          border-x-2 border-b-2 min-h-[37px] rounded-b-xl bg-[#F9FAFB]
