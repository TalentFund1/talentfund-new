      ...
      <div className="flex flex-col h-[74px]">
        ...
        >
          <SelectTrigger className={`
            h-[37px] rounded-t-xl text-sm font-medium w-full capitalize flex items-center justify-center text-[#1f2144]
        ...
        >
          <SelectTrigger className={`
            h-[37px] rounded-b-xl text-sm font-normal text-[#1f2144] w-full flex items-center justify-center gap-2 
