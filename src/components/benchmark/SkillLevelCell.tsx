...
export const SkillLevelCell = ({ 
  ...
  initializeState(skillTitle, initialLevel?.toLowerCase() || 'unspecified', 'unknown');
    ...
    <TableCell className="border-r border-blue-200 p-0">
      <div className="flex flex-col items-center">
        <Select 
          ...
          onValueChange={(value) => {
            setSkillState(skillTitle, value, currentState?.requirement || 'unknown');
            onLevelChange?.(value, currentState?.requirement || 'unknown');
          }}
        >
          ...
          `}>
            <SelectValue>
              <span className="flex items-center gap-1.5">
                {getRequirementIcon(currentState?.requirement || 'unknown')}
