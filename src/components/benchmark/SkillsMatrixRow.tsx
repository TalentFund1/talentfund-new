...
export const SkillsMatrixRow = ({ 
  ...
  return (
    <TableRow className="group border-b border-gray-200">
      <TableCell className="font-medium border-r border-blue-200 py-6">{skill.title}</TableCell>
      <TableCell className="border-r border-blue-200 py-6">{skill.subcategory}</TableCell>
      {showCompanySkill && (
        <TableCell className="text-center border-r border-blue-200 py-6">
