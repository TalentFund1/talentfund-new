...
export const SkillsMatrixRow = ({ 
  ...
  return (
    <TableRow className="group border-b border-gray-200">
      <TableCell className="font-medium border-r border-blue-200 py-2 px-3 w-[180px]">{skill.title}</TableCell>
      <TableCell className="border-r border-blue-200 py-2 px-3 w-[150px]">{unifiedSkillData.subcategory}</TableCell>
      {isRoleBenchmark ? (
        <>
          <RoleSkillLevelCell 
        ...
        <>
          <TableCell className="text-center border-r border-blue-200 py-2 px-3 w-[120px]">
      ...
      <TableCell className="text-center py-2 px-3 w-[100px]">
