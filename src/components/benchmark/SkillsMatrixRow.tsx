...
export const SkillsMatrixRow = ({ skill, showCompanySkill = true, isReadOnly = false }: SkillsMatrixRowProps) => {
  ...
  return (
    <TableRow className="group hover:bg-muted/50">
      ...
      <TableCell className="border-r border-blue-200/60 py-6 px-4 text-muted-foreground">{skill.subcategory}</TableCell>
      {showCompanySkill && (
        <TableCell className="text-center border-r border-blue-200/60 py-6">
