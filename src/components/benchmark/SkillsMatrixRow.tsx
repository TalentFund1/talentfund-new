    ...
    <TableRow className="group hover:bg-muted/50 border-b border-gray-200 transition-colors">
      ...
      <TableCell className="text-center py-2 group-hover:bg-muted/30">
        <div className="flex items-center justify-center space-x-1">
          ...
          <span className="w-5 h-5 rounded-full bg-purple-100 text-purple-800 flex items-center justify-center text-xs font-medium">S</span>
          <span className="w-5 h-5 rounded-full bg-orange-100 text-orange-800 flex items-center justify-center text-xs font-medium">M</span>
