...
export const SkillsMatrixRow = ({ skill, showCompanySkill = true, isReadOnly = false }: SkillsMatrixRowProps) => {
  ...
  return (
    <TableRow className="group hover:bg-muted/50">
      <TableCell className="font-medium border-r border-blue-200/60 py-4 px-4">{skill.title}</TableCell>
      <TableCell className="border-r border-blue-200/60 py-4 px-4 text-muted-foreground">{skill.subcategory}</TableCell>
      {showCompanySkill && (
