    ...
    if (selectedLevel !== 'all' || selectedInterest !== 'all' || 
      ...
      skills = skills.filter(skill => {
        ...
        const competencyState = isRoleBenchmark ? 
          getSkillCompetencyState(skill.title, comparisonLevel, selectedRole, employeeId) :
    ...
    return skills
      .map(skill => ({
        ...
        roleLevel: isRoleBenchmark ? 
          getSkillCompetencyState(skill.title, comparisonLevel, selectedRole, employeeId)?.level || 'unspecified' :
