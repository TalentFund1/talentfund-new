...
export const initialSkills = {
  "130": [
    ...
    { title: "Natural Language Processing (NLP)", subcategory: "AI Applications", level: "advanced", growth: "25%", confidence: "high", requirement: "required", isCompanySkill: true },
    ...
    { title: "Big Data Handling", subcategory: "Data Management", level: "intermediate", growth: "24%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "AI Optimization", subcategory: "AI Performance", level: "intermediate", growth: "26%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Reinforcement Learning", subcategory: "AI & ML", level: "intermediate", growth: "28%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Edge AI", subcategory: "AI Applications", level: "intermediate", growth: "30%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "AI Security", subcategory: "AI Operations", level: "intermediate", growth: "25%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Cloud AI Services", subcategory: "Cloud Computing", level: "intermediate", growth: "27%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Explainable AI", subcategory: "AI Ethics", level: "beginner", growth: "23%", confidence: "medium", requirement: "preferred", isCompanySkill: true },
    { title: "AI Ethics", subcategory: "AI Ethics", level: "beginner", growth: "20%", confidence: "medium", requirement: "preferred", isCompanySkill: true },
    ...
    { title: "API Development", subcategory: "Development", level: "intermediate", growth: "22%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Collaboration", subcategory: "Soft Skills", level: "intermediate", growth: "12%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Version Control", subcategory: "Development Tools", level: "intermediate", growth: "10%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    ...
    { title: "Google Professional Data Engineer", subcategory: "Cloud Certification", level: "intermediate", growth: "28%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Microsoft Certified: Azure AI Engineer Associate", subcategory: "Cloud Certification", level: "intermediate", growth: "30%", confidence: "high", requirement: "preferred", isCompanySkill: true },
    { title: "Certified Ethical AI Engineer", subcategory: "AI Ethics Certification", level: "beginner", growth: "22%", confidence: "medium", requirement: "preferred", isCompanySkill: true }
  ],
  "124": [
    // Specialized Skills
