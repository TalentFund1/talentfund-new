...
import { HelpCircle, Type, Weight } from "lucide-react";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
        ...
        <TableHead className="w-[120px] text-center border-r border-[#CCDBFF] py-3 font-medium">
          <div className="flex items-center justify-center gap-1">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <Weight className="h-4 w-4 text-muted-foreground hover:text-foreground transition-colors" />
                </TooltipTrigger>
        ...
        <TableHead className="w-[120px] text-center border-r border-[#CCDBFF] py-3 font-medium">
          <div className="flex items-center justify-center gap-1">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <Type className="h-4 w-4 text-muted-foreground hover:text-foreground transition-colors" />
                </TooltipTrigger>
                <TooltipContent side="top" align="start" className="max-w-[300px] p-4">
                  <div className="space-y-2">
