        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent border-b border-gray-200 bg-[#F7F9FF]">
              ...
              <TableHead className="text-center border-r border-blue-200 py-2 w-[120px]">Company Skill</TableHead>
              <TableHead className="text-center border-r border-blue-200 py-2 w-[120px]">Skill Level</TableHead>
              <TableHead className="text-center border-r border-blue-200 py-2 w-[120px]">Confidence Score</TableHead>
              <TableHead className="text-center border-r border-blue-200 py-2 w-[120px]">
