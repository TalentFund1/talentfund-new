import { RoleState, RoleSkillState, RoleSkillRequirement, SkillState } from '../../types/SkillTypes';
...
export type { RoleState, RoleSkillState, RoleSkillRequirement, SkillState };