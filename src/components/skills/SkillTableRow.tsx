...
export const SkillTableRow = ({ skill, onGrowthClick }: SkillTableRowProps) => {
  ...
  return (
    <TableRow>
      <TableCell className="font-medium w-[250px] bg-[#F7F9FF]/50 border-x border-border">
        {skill.title}
      </TableCell>
      ...
      <TableCell className="text-center w-[150px] bg-[#F7F9FF]/50 border-x border-border">
        <span 
