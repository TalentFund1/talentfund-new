export const roleSkills = {
  ...
  "127": { // Senior AI Engineer
    specialized: [
      { title: "PyTorch", subcategory: "ML Frameworks", level: "advanced", growth: "28%", salary: "$182,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      ...
      { title: "Neural Networks", subcategory: "AI & ML", level: "advanced", growth: "28%", salary: "$192,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" }
    ],
    common: [
