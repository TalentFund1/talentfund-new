export const roleSkills = {
  "123": { // AI Engineer
    specialized: [
      ...
      { title: "Deep Learning", subcategory: "AI & ML", level: "advanced", growth: "25%", salary: "$182,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      ...
      { title: "PyTorch", subcategory: "ML Frameworks", level: "advanced", growth: "24%", salary: "$182,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" }
    ],
    common: [
...
console.log('Role Skills loaded:', roleSkills);