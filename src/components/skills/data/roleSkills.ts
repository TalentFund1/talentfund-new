export const roleSkills = {
  ...
  "124": { // Backend Engineer - Template Profile
    specialized: [
  ...
  "129": { // Product Manager
    specialized: [
      ...
      { title: "User Experience", subcategory: "Design", level: "advanced", growth: "22%", salary: "$168,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
    ...
    common: [
      ...
      { title: "Strategic Planning", subcategory: "Management", level: "advanced", growth: "22%", salary: "$168,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" }
    ],
    certifications: [
