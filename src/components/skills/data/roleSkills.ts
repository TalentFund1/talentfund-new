export const roleSkills = {
  ...
  "125": { // Frontend Engineer
    ...
    common: [
      { title: "Cross-browser Compatibility", subcategory: "Frontend Development", level: "advanced", growth: "12%", salary: "$165,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" },
      { title: "Responsive Design", subcategory: "Web Development", level: "advanced", growth: "18%", salary: "$168,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" },
      { title: "Problem Solving", subcategory: "Soft Skills", level: "advanced", growth: "15%", salary: "$158,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" }
    ],
    certifications: [
      { title: "AWS Certified Developer - Associate", subcategory: "Cloud Certification", level: "intermediate", growth: "25%", salary: "$170,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" },
  ...
  "127": { // Senior AI Engineer
    specialized: [
      { title: "PyTorch", subcategory: "ML Frameworks", level: "advanced", growth: "28%", salary: "$195,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      { title: "Computer Vision", subcategory: "AI Applications", level: "advanced", growth: "25%", salary: "$192,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      { title: "MLOps", subcategory: "AI & ML", level: "advanced", growth: "30%", salary: "$198,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      { title: "Reinforcement Learning", subcategory: "AI & ML", level: "advanced", growth: "22%", salary: "$190,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      { title: "Neural Networks", subcategory: "AI & ML", level: "advanced", growth: "28%", salary: "$195,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" }
    ],
    common: [
      { title: "Python", subcategory: "Programming Languages", level: "advanced", growth: "25%", salary: "$185,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      { title: "Problem Solving", subcategory: "Soft Skills", level: "advanced", growth: "15%", salary: "$180,000", benchmarks: { J: true, B: true, O: true }, requirement: "required" },
      { title: "Technical Writing", subcategory: "Communication", level: "intermediate", growth: "12%", salary: "$175,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" }
    ],
    certifications: [
      { title: "Google Cloud Professional Machine Learning Engineer", subcategory: "Cloud Certification", level: "advanced", growth: "28%", salary: "$192,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" },
      { title: "PyTorch Developer Certificate", subcategory: "AI Certification", level: "advanced", growth: "20%", salary: "$188,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" },
      { title: "Azure AI Engineer Associate", subcategory: "Cloud Certification", level: "advanced", growth: "25%", salary: "$190,000", benchmarks: { J: true, B: true, O: true }, requirement: "preferred" }
    ]
  }
};
