...
export const skills = [
  ...
  .concat(versionControlSkills);

// Update the normalizations to ensure consistent naming
...
console.log('Loaded skills:', {
  ...
  normalizedGitSkills: skills.filter(s => s.title === 'Git Version Control').length
});
