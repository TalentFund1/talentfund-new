  ...
  return (
    <tr className="border-b border-border">
      ...
      <th className={`h-12 px-10 text-left text-sm font-medium text-muted-foreground whitespace-nowrap ${
        hasSelectedSkills ? 'w-[600px]' : 'w-[400px]'
      }`}>Employee Name</th>
      ...
      <th className="h-12 px-12 text-center text-sm font-medium text-muted-foreground w-[150px] whitespace-nowrap">Skill Match</th>
      <th className="h-12 px-12 text-center text-sm font-medium text-muted-foreground w-[150px] whitespace-nowrap">Competency Match</th>
      {!hasSelectedSkills && (
        <th className="h-12 px-6 text-center text-sm font-medium text-muted-foreground w-[120px]">Benchmark</th>
      )}
      {hasSelectedSkills && (
        <>
          <th className="h-12 px-6 text-left text-sm font-medium text-muted-foreground w-[350px]">Skills</th>
          <th className="h-12 px-6 text-left text-sm font-medium text-muted-foreground w-[350px]">Adjacent Skills</th>
        </>
      )}
      {!hasSelectedSkills && (
